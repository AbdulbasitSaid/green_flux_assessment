...
### Note: Make command can also be used in this project
 ...
 if you don't already use makefiles, run the following command first: ``brew install make`` this will install make util to your mac. but if you are on Linux no need. If you are on windows I suggest the first instructions on **How it works**.
